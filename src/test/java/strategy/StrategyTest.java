...
public class StrategyTest {
  ...
  public void interfaceDiscountService_IsCreated() {
    try {
      Class<?> discountServiceInterface = Class.forName("strategy.DiscountService");
  ...
  public void interfaceDiscountService_HasThreeImplementations() {
    try {
      Class.forName("strategy.impl.BirthdayDiscountService");
      Class.forName("strategy.impl.BlackFridayDiscountService");
      Class.forName("strategy.impl.NewYearDiscountService");
      Class.forName("strategy.impl.DefaultDiscountService");
    } catch (ClassNotFoundException e) {
  ...
  public void classDiscountStrategy_IsCreated() {
    try {
      Class<?> discountStrategyClass = Class.forName("strategy.DiscountStrategy");
