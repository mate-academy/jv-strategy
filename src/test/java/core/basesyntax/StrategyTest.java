...
public class StrategyTest {
  ...
  public void interfaceDiscountService_HasThreeImplementations() {
    try {
      Class.forName("core.basesyntax.strategy.strategy.impl.BirthdayDiscountService");
      Class.forName("core.basesyntax.strategy.strategy.impl.BlackFridayDiscountService");
      Class.forName("core.basesyntax.strategy.strategy.impl.NewYearDiscountService");
      Class.forName("core.basesyntax.strategy.strategy.impl.DefaultDiscountService");
    } catch (ClassNotFoundException e) {
