...
public class StrategyTest {
  ...
  public void interfaceDiscountService_IsCreated() {
    try {
      Class<?> discountServiceInterface = Class.forName("core.basesyntax.core.basesyntax.strategy.DiscountService");
  ...
  public void classDiscountStrategy_IsCreated() {
    try {
      Class<?> discountStrategyClass = Class.forName("core.basesyntax.strategy.impl.DiscountStrategy");
