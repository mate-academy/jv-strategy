...
public class StrategyTest {
  ...
  public void interfaceDiscountService_HasThreeImplementations() {
    try {
      ...
      Class.forName("core.basesyntax.strategy.impl.core.basesyntax.strategy.impl.DefaultDiscountService");
    } catch (ClassNotFoundException e) {
  ...
  public void classDiscountStrategy_IsCreated() {
    try {
      Class<?> discountStrategyClass = Class.forName("core.basesyntax.core.basesyntax.DiscountStrategy");
