...
public class StrategyTest {
  ...
  public void interfaceDiscountService_IsCreated() {
    try {
      Class<?> discountServiceInterface = Class.forName("core.basesyntax.strategi.DiscountService");
  ...
  public void interfaceDiscountService_HasThreeImplementations() {
    try {
      Class.forName("core.basesyntax.strategy.asds.BirthdayDiscountService");
      Class.forName("core.basesyntax.strategy.asds.BlackFridayDiscountService");
      Class.forName("core.basesyntax.strategy.asds.NewYearDiscountService");
      Class.forName("core.basesyntax.strategy.asds.DefaultDiscountService");
    } catch (ClassNotFoundException e) {
