...
In case the passed `specialEvent` doesn't have a specific implementation you must return `core.basesyntax.strategy.impl.DefaultDiscountService` by default.
